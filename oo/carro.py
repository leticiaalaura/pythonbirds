...
O motor terá que controlar a velocidade. Ele oferece os seguintes atributos:
1) Atributo de dado velocidade
2) Método acelerar. que deverá incrementar a velocidade a uma unidade
3) Método frear que deverá incrementar a velocidade em duas unidades
